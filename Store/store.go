...
const uri = "mongodb+srv://medha:drumDRO67%23%24@cluster0.qj0tdiv.mongodb.net/"
	...
	func (m *MongoStore) OpenConnectionWithMongoDB() {
		...
		var result bson.M
		if err := client.Database("attdapp").RunCommand(context.TODO(), bson.D{{"ping", 1}}).Decode(&result); err != nil {
			panic(err)
		}
	...
	func (m *MongoStore) StoreUserData(user Models.User, file multipart.File, filename string) error {
